...
export function Solicitudes() {
  ...
  const filteredSolicitudes = solicitudes.filter(sol => {
    ...
    const areaName = (sol.area_nombre || `Consulta #${sol.id}`).toLowerCase();
                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-3">
                      <div>
                        ...
                        <h3 className="text-[16px] font-bold text-gray-900 mt-0.5">{sol.area_nombre || "Área no especificada"}</h3>
                      </div>
